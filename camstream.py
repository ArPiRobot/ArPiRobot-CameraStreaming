...
if __name__ == "__main__":
    ...
    parser.add_argument("--driver", type=str, choices=["libcamera", "v4l2"], default="libcamera", help="Which input device driver to use. V4L2 supports USB cameras. Libcamera only supports the pi camera modules. Default = libcamera")
    parser.add_argument("--device", type=str, default="", help="Device identifier for which camera to use (does not apply to libcamera driver).")
    ...
    parser.add_argument("--h264encoder", metavar="ENCODER", type=str, choices=["v4l2enc", "libx264"], default="v4l2enc", help="Which h.264 encoder to use with V4L2 (no effect with libcamera driver) Choices = libav-omx, omx, libx264. Default = libav-omx.")
    ...
    parser.add_argument("--bitrate", type=int, default=2048000, help="Bitrate for H.264 stream. Default = 2048000")
    ...
    parser.add_argument("--quality", metavar="QUALITY", type=int, choices=range(1, 100), default=50, help="JPEG image quality (1-100) for MPEG stream (does not apply to H.264). Default = 50")
