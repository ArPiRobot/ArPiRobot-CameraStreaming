...
if __name__ == "__main__":
    ...
    parser.add_argument("--driver", type=str, choices=["libcamera"], default="libcamera", help="Which input device driver to use. V4L2 supports USB cameras. Libcamera and raspicam only support the pi camera modules (libcamera being the new stack). Default = libcamera")
    ...
    parser.add_argument("--rotate", metavar="ROTATION", type=int, choices=[0, 90, 180, 270, 360], default=0, help="Rotate camera image (0, 90, 180, 270, 360). Default = 0")
